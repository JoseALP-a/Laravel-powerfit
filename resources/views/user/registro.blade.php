...
@section('content')
<div style="display:flex; justify-content:center; align-items:flex-start; padding:50px 20px;">
    ...
    ">
        ...
        <h2 style="text-align:center; color:#ff6600; font-size:2rem; font-weight:700; margin-bottom:25px;">
